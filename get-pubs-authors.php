...
$result = odbc_exec($connect, $query);
 ...
 $i=1;
 $dois = 'LeadProjectCode,WebSafeProjectCode,ResourceType,ResourceTypeId,AttribToProject,Countries,WOKID,timescited,RoundName,DatePublished,DOI,Edition,ISBN,ISSN,IssueNumber,Keywords,Language,PublicationLocation,Publisher,PageReference,TitleOfJournal,Title,FullTitle,VolumeNumber,Year,Authors' . PHP_EOL;
...
$conts = $authors . $coauthors;
$roles = array(" (Author)"," (Co-Author)"," (Editor)"," (Co-author)"," (Contributor)");
$contributors = str_replace($roles,'',$conts);


  	$dois .= '"' . odbc_result($result,'LeadProjectCode') . '","' . $safecode . '","' . $pubtype . '","' . $type . '","' . odbc_result($result,'AttribToProject') . '","' . odbc_result($result,'Countries') . '","' . odbc_result($result,'WOKID') . '","' . $cites . '","' . odbc_result($result,'RoundName') . '","' . odbc_result($result,'DatePublished') . '","' . odbc_result($result,'DOI') . '","' . odbc_result($result,'Edition') . '","' . odbc_result($result,'ISBN') . '","' . odbc_result($result,'ISSN') . '","' . odbc_result($result,'IssueNumber') . '","' . odbc_result($result,'Keywords') . '","' . odbc_result($result,'Language') . '","' . odbc_result($result,'PublicationLocation') . '","' . odbc_result($result,'Publisher') . '","' . odbc_result($result,'PageReference') . '","' . odbc_result($result,'TitleOfJournal') . '","' . $shorttitle . '","' .$fulltitle . '","' . odbc_result($result,'VolumeNumber') . '","' . $year . '","' . $contributors . '"' . PHP_EOL;
